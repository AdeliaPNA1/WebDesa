...
if (count($_FILES) > 0) {
    if (is_uploaded_file($_FILES['gambar']['tmp_name'])) {
        ...
        $sql = "INSERT INTO gambarstruktur(tipegambar ,datagambar) VALUES('" . $propertiesgambar['mime'] . "', '" . $datagambar . "')";
        mysqli_query($koneksi, $sql) or die("<b>Error:</b> Ada kesalahan<br/>" . mysqli_error($koneksi));

        $lastrecord = "SELECT id FROM gambarstruktur ORDER BY id DESC LIMIT 1";
