  ...
  <header class="mb-auto">
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        ...
        <p class="lead">Geneng Duwur adalah desa di kecamatan Gemolong, Sragen, Jawa Tengah, Indonesia. Kantor kelurahan Desa Geneng Duwur terdiri dari beberapa pegawai yang bekerja untuk mengurus desa Geneng Duwur dan beralamatkan di Jln. Sukowati Km. 1,5 Gemolong, Sragen Kode Pos 57274. </p><button class="btn btn-primary btn-lg" type="button">Pengaturan</button>
      </div>
